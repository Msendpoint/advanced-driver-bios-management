<#
.SYNOPSIS
    One-click installer and launcher for Advanced Driver & BIOS Management
...
Write-Host "    Advanced Driver & BIOS Management" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/advanced-driver-bios-management.ps1"
